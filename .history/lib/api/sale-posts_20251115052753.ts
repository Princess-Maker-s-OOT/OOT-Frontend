...
): Promise<ApiResponse<SalePostCreateResponse>> {
  return apiPost(`${API_URL}/sale-posts`, request)
}
...
export async function getSalePostDetail(
  salePostId: number
): Promise<ApiResponse<SalePostDetailResponse>> {
  return apiGet(`${API_URL}/sale-posts/${salePostId}`)
}
...
export async function getSalePosts(params: {
  ...
  sort?: string
  direction?: "ASC" | "DESC"
}): Promise<ApiResponse<SliceResponse<SalePostListResponse>>> {
  ...
  return apiGet(`${API_URL}/sale-posts?${queryParams.toString()}`)
}
...
export async function updateSalePost(
  ...
  return apiPut(`${API_URL}/sale-posts/${salePostId}`, request)
}
...
export async function deleteSalePost(
  ...
  return apiDelete(`${API_URL}/sale-posts/${salePostId}`)
}
...
export async function updateSaleStatus(
  ...
  return apiPost(`${API_URL}/sale-posts/${salePostId}/status`, { status })
}
...
export async function getMySalePosts(params: {
  ...
  return apiGet(`${API_URL}/sale-posts/my?${queryParams.toString()}`)
}
