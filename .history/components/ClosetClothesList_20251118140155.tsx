    ...
    <div className="max-w-4xl w-full mx-auto p-8">
      <div className="grid grid-cols-2 md:grid-cols-3 gap-32 w-full">
        {items.map((item) => {
          ...
          return (
            <div key={item.linkId} className="relative flex flex-col items-center justify-between border rounded-xl bg-white shadow-sm p-4 aspect-square min-h-[220px] w-40 md:w-48">
              {/* X 버튼 오른쪽 상단 */}
              {isMine && (
                <button
