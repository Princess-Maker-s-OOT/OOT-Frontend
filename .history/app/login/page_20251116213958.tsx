...
export default function LoginPage() {
      ...
      if (result.success && result.data) {
        ...
        try {
          ...
          console.log("로그인 성공:", { 
            ...
            userId: payload.sub, 
            userRole,
            jwtRole: payload.userRole || payload.role,
          ...
          if (userInfoResponse.ok) {
            ...
            console.log("기본 사용자 정보 저장:", { loginId: parsed.data.loginId, role: userRole })
          }
  ...
  function handleGoogleLogin() {
    // 백엔드 context-path가 /api이므로 /api 제거
    const API_BASE = process.env.NEXT_PUBLIC_API_URL || "http://localhost"
    // Spring Security OAuth2는 /oauth2/authorization/{provider} 패턴 사용
    // context-path 적용되므로 최종 URL: http://localhost:8080/api/oauth2/authorization/google
