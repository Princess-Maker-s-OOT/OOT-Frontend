...
export async function getSalePosts(params: {
  ...
  return apiGet(`${API_BASE_URL}/api/v1/sale-posts?${queryParams.toString()}`)
}
...
export async function updateSalePost(
  ...
  return apiPut(`${API_BASE_URL}/api/v1/sale-posts/${salePostId}`, request)
}
...
export async function updateSaleStatus(
  ...
  return apiPost(`${API_BASE_URL}/api/v1/sale-posts/${salePostId}/status`, { status })
}
