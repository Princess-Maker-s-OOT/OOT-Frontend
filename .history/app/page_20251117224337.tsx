...
export default function Home() {
  ...
  return (
    <main className="min-h-[480px] bg-[#e3f2fd] flex flex-col items-center font-serif justify-center text-center">
      {/* 대형 브랜드 헤더 */}
      ...
      <section className="w-full flex flex-col items-center justify-center px-4 py-2 mb-2">
        <h1 className="text-5xl font-extrabold text-[#1A2A4F] mb-2 tracking-tight drop-shadow-lg font-serif">오늘의 옷, 오늘의 가치</h1>
        <p className="text-xl font-medium text-[#5A1A2F] mb-1 font-serif">패션의 순환, 환경을 생각하는 <span className='font-bold text-[#D8CBB3]'>OOT 마켓</span></p>
      </section>
      ...
      <section className="w-full flex flex-row gap-6 px-4 mb-4 justify-center items-center">
        ...
        <a href="/sale-posts" className="flex flex-row items-center justify-center hover:scale-[1.04] transition cursor-pointer" style={{maxWidth: '520px'}}>
          <div className="flex flex-row items-center bg-white rounded-2xl shadow-xl p-0" style={{height: '360px', width: '520px'}}>
            ...
            <div className="flex flex-col items-center justify-center text-center" style={{width: '260px', height: '360px'}}>
              <h2 className="text-3xl font-extrabold text-[#1A2A4F] mb-2 font-serif drop-shadow">OOT 마켓</h2>
              <p className="text-xl text-[#5A1A2F] mb-3 font-medium font-serif">
                오늘의 거래, 환경 보호<br />
                <span className="text-[#D8CBB3] font-bold">가치의 순환</span><br />
              </p>
            </div>
          </div>
        </a>
        ...
        <a href="/closets/public" className="flex flex-row items-center justify-center hover:scale-[1.04] transition cursor-pointer" style={{maxWidth: '520px'}}>
          <div className="flex flex-row items-center bg-white rounded-2xl shadow-xl p-0" style={{height: '360px', width: '520px'}}>
            ...
            <div className="flex flex-col items-center justify-center text-center" style={{width: '260px', height: '360px'}}>
              <h2 className="text-3xl font-extrabold text-[#1A2A4F] mb-2 font-serif drop-shadow">OOT 옷장</h2>
              <p className="text-xl text-[#5A1A2F] mb-3 font-medium font-serif">
                나만의 옷장, 셀럽/인플루언서<br />
                <span className="text-[#D8CBB3] font-bold">리얼 데일리룩</span>
              </p>
            </div>
          </div>
        </a>
      ...
      <section className="w-full flex justify-center items-center py-2 mb-1 text-center">
        <span className="text-lg font-bold text-[#1A2A4F] font-serif drop-shadow">옷의 새로운 여정, 오늘 당신이 이어주세요.</span>
      </section>
