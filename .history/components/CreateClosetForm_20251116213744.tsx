...
export default function CreateClosetForm() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // 메타데이터 저장
      console.log("[CreateClosetForm] 메타데이터 저장 시작")
      console.log("file.name:", file.name)
      console.log("file.size:", file.size)
      console.log("file.type:", file.type)
      console.log("presignedResult.data.fileUrl:", presignedResult.data.fileUrl)
      console.log("presignedResult.data.s3Key:", presignedResult.data.s3Key)
      ...
      if (saveResult.success && saveResult.data) {
        ...
        console.error("메타데이터 저장 실패:", saveResult)
