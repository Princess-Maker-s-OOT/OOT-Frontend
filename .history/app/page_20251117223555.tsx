  ...
  return (
    <main className="min-h-[480px] bg-[#e3f2fd] flex flex-col items-center font-sans justify-center text-center">
      ...
      <section className="w-full flex flex-row gap-4 px-4 mb-4 justify-center items-center">
        {/* 중고마켓 카드 (판매글 목록으로 이동) */}
        <a href="/sale-posts" className="basis-1/2 min-w-[400px] max-w-[500px] bg-white rounded-2xl shadow-xl p-8 flex flex-row items-center hover:scale-[1.02] transition border border-gray-100 cursor-pointer" style={{height: '220px'}}>
          <Image src="/메인2.png" alt="Market" width={320} height={160} className="rounded-xl object-cover mr-6 flex-shrink-0" />
        ...
        {/* 옷장 카드 (공개옷장 목록으로 이동) */}
        <a href="/closets/public" className="basis-1/2 min-w-[400px] max-w-[500px] bg-white rounded-2xl shadow-xl p-8 flex flex-row items-center hover:scale-[1.02] transition border border-gray-100 cursor-pointer" style={{height: '220px'}}>
          <Image src="/메인3.png" alt="Closet" width={320} height={160} className="rounded-xl object-cover mr-6 flex-shrink-0" />
          <div className="flex flex-col items-center justify-center text-center w-full">
