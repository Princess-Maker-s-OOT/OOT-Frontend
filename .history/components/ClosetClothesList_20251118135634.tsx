    ...
    <div className="max-w-3xl mx-auto p-6">
      <div className="grid grid-cols-2 md:grid-cols-3 gap-32">
        {items.map((item) => {
          ...
          return (
            <div key={item.linkId} className="relative flex flex-col items-center justify-between border rounded-2xl bg-white shadow-lg p-6 aspect-square min-h-[220px] w-40 md:w-48">
              {/* X 버튼 오른쪽 상단 */}
              {isMine && (
                <button
