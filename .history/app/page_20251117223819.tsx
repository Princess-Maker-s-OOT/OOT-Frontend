...
export default function Home() {
  ...
  return (
    <main className="min-h-[480px] bg-[#e3f2fd] flex flex-col items-center font-sans justify-center text-center">
      ...
      {/* 메인 마켓/옷장 카드 섹션 */}
      <section className="w-full flex flex-col gap-4 px-4 mb-4 justify-center items-center">
        {/* 중고마켓 카드 (판매글 목록으로 이동) */}
        <a href="/sale-posts" className="flex flex-row items-center justify-center hover:scale-[1.02] transition cursor-pointer mx-auto" style={{maxWidth: '700px'}}>
          <div className="flex flex-row items-center bg-white rounded-2xl shadow-xl p-0" style={{height: '260px', width: '520px'}}>
            <div style={{width: '260px', height: '260px', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
              <Image src="/메인2.png" alt="Market" width={220} height={220} className="rounded-l-2xl object-cover" style={{width: '220px', height: '220px'}} />
            </div>
            <div className="flex flex-col items-center justify-center text-center" style={{width: '260px', height: '260px'}}>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">OOT 중고마켓</h2>
              <p className="text-lg text-gray-600 mb-3">오늘의 거래, 옷의 새로운 여정, 당신이 이어주세요</p>
            </div>
          </div>
        </a>
        {/* 옷장 카드 (공개옷장 목록으로 이동) */}
        <a href="/closets/public" className="flex flex-row items-center justify-center hover:scale-[1.02] transition cursor-pointer mx-auto" style={{maxWidth: '700px'}}>
          <div className="flex flex-row items-center bg-white rounded-2xl shadow-xl p-0" style={{height: '260px', width: '520px'}}>
            <div style={{width: '260px', height: '260px', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
              <Image src="/메인3.png" alt="Closet" width={220} height={220} className="rounded-l-2xl object-cover" style={{width: '220px', height: '220px'}} />
            </div>
            <div className="flex flex-col items-center justify-center text-center" style={{width: '260px', height: '260px'}}>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">OOT 옷장</h2>
              <p className="text-lg text-gray-600 mb-3">나만의 옷장, 셀럽/인플루언서의 리얼 데일리룩</p>
            </div>
          </div>
        </a>
      </section>
