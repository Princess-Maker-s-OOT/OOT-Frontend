import type { DonationCenter } from "../types/donation"
import { apiGet, apiPost } from "./client"
import type { ApiResult } from "./client"
import type { PaginatedResponse } from "../types/common"
import type { SearchDonationCentersSuccessResponse } from "../types/donation"
import type {
...
export async function getMyRecommendations(
...
): Promise<ApiResult<PaginatedResponse<RecommendationGetMyResponse>>> {
  ...
  return apiGet<PaginatedResponse<RecommendationGetMyResponse>>(
...
export async function searchDonationCentersFromRecommendation(
  ...
  radius?: number,
  keyword?: string
): Promise<ApiResult<DonationCenter[]>> {
  const params = new URLSearchParams()
  ...
  return apiGet<DonationCenter[]>(url, { requiresAuth: true })
}