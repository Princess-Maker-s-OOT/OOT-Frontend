    ...
    <div className="max-w-5xl mx-auto p-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-16">
        {items.map((item) => {
          ...
          return (
            <div key={item.linkId} className={`relative flex flex-col items-center justify-between border-2 border-pink-200 rounded-2xl bg-sky-50 shadow-lg p-8 aspect-square min-h-[240px] transition hover:scale-105 hover:shadow-xl`}>
              {/* X 버튼 오른쪽 상단 */}
              {isMine && (
                <button
              ...
              {isMine && (
                <div className="w-full flex justify-center mt-6">
                  <button
                    ...
                    className="w-10/12 py-3 bg-gradient-to-r from-pink-400 to-sky-400 text-white rounded-full hover:from-pink-500 hover:to-sky-500 font-bold shadow-lg text-base transition"
                  >
