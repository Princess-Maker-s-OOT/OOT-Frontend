...
export default function DonationCenterList() {
  ...
  useEffect(() => {
    ...
    console.log("🔍 Checking Kakao Maps API availability:", {
      LatLng: typeof kakao.maps.LatLng,
      Map: typeof kakao.maps.Map,
      Marker: typeof kakao.maps.Marker,
    })

    // LatLng이 constructor가 아니면 경고 표시하고 종료
    if (typeof kakao.maps.LatLng !== "function") {
      console.error("❌ Kakao Maps API not ready. LatLng is not a constructor.")
      console.log("💡 Suggestion: Check if SDK loaded correctly or try refreshing the page")
      return
    }
