...
export async function requestTransaction(
  ...
  return apiPost<TransactionResponse>(`${API_BASE_URL}/api/v1/transactions/request`, request)
}
...
export async function acceptTransaction(
  transactionId: number
): Promise<ApiResult<TransactionAcceptResponse>> {
  return apiPost<TransactionAcceptResponse>(`${API_BASE_URL}/api/v1/transactions/${transactionId}/accept`, {})
}
...
export async function completeTransaction(
  transactionId: number
): Promise<ApiResult<TransactionCompleteResponse>> {
  return apiPost<TransactionCompleteResponse>(`${API_BASE_URL}/api/v1/transactions/${transactionId}/complete`, {})
}
...
export async function cancelTransactionByBuyer(
  transactionId: number
): Promise<ApiResult<TransactionCancelResponse>> {
  return apiPost<TransactionCancelResponse>(`${API_BASE_URL}/api/v1/transactions/${transactionId}/cancel-buyer`, {})
}
