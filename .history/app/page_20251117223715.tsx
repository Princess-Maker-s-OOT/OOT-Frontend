  ...
  return (
    <main className="min-h-[480px] bg-[#e3f2fd] flex flex-col items-center font-sans justify-center text-center">
      ...
      <section className="w-full flex flex-col gap-4 px-4 mb-4 justify-center items-center">
        {/* 중고마켓 카드 (판매글 목록으로 이동) */}
        <a href="/sale-posts" className="flex flex-row items-center justify-center hover:scale-[1.02] transition cursor-pointer mx-auto" style={{maxWidth: '500px'}}>
          <div className="flex flex-row items-center bg-white rounded-2xl shadow-xl p-0" style={{height: '160px', minWidth: '320px', width: '100%'}}>
            <Image src="/메인2.png" alt="Market" width={160} height={160} className="rounded-l-2xl object-cover flex-shrink-0" />
        ...
        {/* 옷장 카드 (공개옷장 목록으로 이동) */}
        <a href="/closets/public" className="flex flex-row items-center justify-center hover:scale-[1.02] transition cursor-pointer mx-auto" style={{maxWidth: '500px'}}>
          <div className="flex flex-row items-center bg-white rounded-2xl shadow-xl p-0" style={{height: '160px', minWidth: '320px', width: '100%'}}>
            <Image src="/메인3.png" alt="Closet" width={160} height={160} className="rounded-l-2xl object-cover flex-shrink-0" />
            <div className="flex flex-col items-center justify-center text-center w-full h-full px-6">
