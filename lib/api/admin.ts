...
export async function getUserStatistics(
  ...
  const response = await fetch("http://localhost:8080/api/admin/v1/dashboards/users/statistics", {
    method: "GET",
    headers: {
...
export async function getClothesStatistics(
  ...
  const response = await fetch("http://localhost:8080/api/admin/v1/dashboards/clothes/statistics", {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${accessToken}`,
...
export async function getSalePostStatistics(
  ...
  const response = await fetch("http://localhost:8080/api/admin/v1/dashboards/sale-posts/statistics", {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${accessToken}`,
...
export async function getPopularCategoryStatistics(
  ...
  const response = await fetch("http://localhost:8080/api/admin/v1/dashboards/popular", {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${accessToken}`,
