  ...
  return (
    <main className="min-h-[480px] bg-[#e3f2fd] flex flex-col items-center font-sans justify-center text-center">
      ...
      <section className="w-full flex flex-row gap-4 px-4 mb-4 justify-center items-center">
        {/* 중고마켓 카드 (판매글 목록으로 이동) */}
        <a href="/sale-posts" className="flex-1 max-w-xs bg-white rounded-2xl shadow-xl p-6 flex flex-col items-center justify-center hover:scale-[1.02] transition border border-gray-100 cursor-pointer text-center">
          <Image src="/메인2.png" alt="Market" width={220} height={110} className="rounded-xl object-cover mx-auto mb-3" />
        ...
        {/* 옷장 카드 (공개옷장 목록으로 이동) */}
        <a href="/closets/public" className="flex-1 max-w-xs bg-white rounded-2xl shadow-xl p-6 flex flex-col items-center justify-center hover:scale-[1.02] transition border border-gray-100 cursor-pointer text-center">
          <Image src="/메인3.png" alt="Closet" width={220} height={110} className="rounded-xl object-cover mx-auto mb-3" />
