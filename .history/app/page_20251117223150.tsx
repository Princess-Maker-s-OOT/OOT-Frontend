...
export default function Home() {
  ...
  return (
    <main className="min-h-[480px] bg-[#e3f2fd] flex flex-col items-center font-sans justify-center">
      {/* 대형 브랜드 헤더 */}
      <header className="w-full flex flex-row items-center justify-end px-4 py-2 mb-1">
        {/* 헤더만, 로고/네비 제거 */}
      </header>

      {/* 트렌디 슬로건 & 환경 메시지 */}
      <section className="w-full flex flex-row items-center px-4 py-2 mb-2">
        <div>
      ...
      {/* 메인 마켓/옷장 카드 섹션 */}
      <section className="w-full flex flex-row gap-4 px-4 mb-4">
        {/* 중고마켓 카드 (판매글 목록으로 이동) */}
      ...
      {/* 하단 멘트 */}
      <section className="w-full flex justify-center items-center py-2 mb-1">
