  ...
  return (
    <main className="min-h-[480px] bg-[#e3f2fd] flex flex-col items-center font-sans justify-center text-center">
      ...
      <section className="w-full flex flex-row gap-4 px-4 mb-4 justify-center items-center">
        {/* 중고마켓 카드 (판매글 목록으로 이동) */}
        <a href="/sale-posts" className="flex-1 flex flex-row items-center justify-center hover:scale-[1.02] transition cursor-pointer" style={{maxWidth: '500px'}}>
        ...
        {/* 옷장 카드 (공개옷장 목록으로 이동) */}
        <a href="/closets/public" className="flex-1 flex flex-row items-center justify-center hover:scale-[1.02] transition cursor-pointer" style={{maxWidth: '500px'}}>
          <div className="flex flex-row items-center bg-white rounded-2xl shadow-xl p-0" style={{height: '160px', minWidth: '320px', width: '100%'}}>
