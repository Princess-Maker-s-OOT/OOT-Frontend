...
export async function requestTransaction(
  ...
  return apiPost(`${API_URL}/transactions/request`, request)
}
...
export async function acceptTransaction(
  ...
  return apiPost(`${API_URL}/transactions/${transactionId}/accept`, {})
}
...
export async function completeTransaction(
  ...
  return apiPost(`${API_URL}/transactions/${transactionId}/complete`, {})
}
...
export async function cancelTransactionByBuyer(
  ...
  return apiPost(`${API_URL}/transactions/${transactionId}/cancel-buyer`, {})
}
